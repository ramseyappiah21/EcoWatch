...
Copy-paste these **full** values (do not shorten the email):
...
**Wrong (will fail):** `nadmo.emergency@` alone, or password `emg123` / `nadmo123`.
...
| Emergency desk | `nadmoemg@ecowatch.gov` |
